...
class GazeSensor():
    ...
    def play_video_and_track_gaze(self):
        ...
        while self.cap.isOpened():
            ...
            # Rotate 90 degrees clockwise and flip along the y-axis
            frame = np.rot90(frame, k=-1)  # Rotate 90 degrees clockwise
            ...
            if parsed_data:
                ...
                # Append pixel data to parsed_data
                parsed_data['X_Pixel'] = x_pixel
                parsed_data['Y_Pixel'] = y_pixel
...
video_path = r'C:\Users\Dhanush\PycharmProjects\gazepoint_LIRA\media\demo_8_video.mp4'  # Replace with your video path
